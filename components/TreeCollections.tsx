...
const TreeCollections: React.FC<TreeCollectionsProps> = ({ user, setUser, onBack }) => {
          ...
          return (
            <div 
              ...
              className={`p-6 rounded-[2.5rem] border-2 transition-all cursor-pointer ${
                isSelected ? 'border-emerald-500 bg-emerald-50' : isUnlocked ? 'border-slate-100 bg-slate-50' : 'border-slate-100 bg-slate-50 opacity-60'
              }`}
            >
