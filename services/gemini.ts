...
export async function generateOrnament(prompt: string, size: ImageSize): Promise<string | null> {
...
export async function chatWithSpirit(history: Message[], userInput: string, journalEntries: JournalEntry[]): Promise<string> {
  const ai = getGeminiClient();
